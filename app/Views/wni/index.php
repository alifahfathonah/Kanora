...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Data Penumpang WNI</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="#">Halaman</a></li>
                        <li class="breadcrumb-item active">Data Penumpang WNI</li>
                    </ol>
                                        ...
                                        <td>
                                            ...
                                            <div class="nav-item dropdown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right">
                                                    <form action="<?= base_url('Passanger/wni/detail') . '/' . $row['id_passanger'] ?>" method="post">
                                                        <?= csrf_field(); ?>
                                                    ...
                                                    <form action="<?= base_url('Passanger/wni/update') . '/' . $row['id_passanger'] ?>" method="post">
                                                        <?= csrf_field(); ?>
                                                    ...
                                                    <div class="dropdown-divider"></div>
                                                    <form action="<?= base_url('Passanger/wni/delete') . '/' . $row['id_passanger'] ?>" method="post">
                                                        <?= csrf_field(); ?>
